r_live_mca <-  function(data1, data2, nchunk, f = 0,disk = TRUE) {
...
#   eg$m = eg$n 
   ### coordinate computation
    ...
    # row standard / principal coordinates
  ...
  out = list()
  out$colpcoordStart = PC1[,c(1:dims)]/sqrt(nchunk+1)
